...
public abstract class LinkrModificationManager extends CyanComponent {

	private static LinkrModificationManager instance;
	private static boolean prepared = false;

	/**
	 * Assigns the instance.
	 */
	protected static void assign(LinkrModificationManager instance) {
		LinkrModificationManager.instance = instance;
	}
